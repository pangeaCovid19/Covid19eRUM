...
N(t) = ae^{ce^{-Kt}},
$$
in cui il parametro $a$ rappresenta il valore asintotico, ovvero il numero dei deceduti o dei casi totali che si registreranno alla fine dell'epidemia. Con i dati registrati fino ad oggi otteniamo una stima del parametro $a$ per i casi totali pari a <span class="myclass">`r coefficients(modellogomp)[1]`</span>.
